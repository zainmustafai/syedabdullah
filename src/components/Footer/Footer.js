...
const Footer = () => {
  return (
    <div className="w-full bg-[#252934] h-[15vh] mt-8 ">
            ...
            <div className="flex flex-wrap items-center justify-between md:flex-nowrap">
              <div className="w-full space-x-12 flex justify-center text-gray-300 sm:w-7/12 md:justify-start">
                <ul className="space-y-8">
                  <li>
                    <a
                      href="https://www.facebook.com/syed038/"
                  ...
                  <li>
                    <a
                      href="https://www.instagram.com/syedabdullah600/?hl=en"
                      className="flex items-center space-x-3 hover:text-sky-400 transition"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <li>
                    <a
                      href="https://www.linkedin.com/in/syed-abdullah-88113b245/"
                      className="flex items-center space-x-3 hover:text-sky-400 transition"
                    >
                      {/* SVG HERE */}
                      <svg
              ...
              <div className="w-10/12 m-auto  mt-16 space-y-6 text-center sm:text-left sm:w-5/12 sm:mt-auto">
                <span className="block text-gray-300 text-center">
                  Let's collaborate and embark on a journey of creative
                  exploration together! 😊
                </span>

                <span className="block text-gray-300 text-center">
                  {" "}
                  SYED ABDULLAH &copy; 2023
                </span>
              </div>
            </div>
          </div>
...
//<p classNameName='text-yellow-600'>MUHAMMAD ZAIN UL ABIDIN © 2022 </p>
